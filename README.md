...
| Fixes malformed EXIF date formatting | Includes files in DCIM subfolders |
...
Terminal progress updates in place:
...
- **Existing files:** “Overwrite?” defaults to **No** (skip). `--auto` never overwrites.
...
<details>
<summary><strong>Optional: launch automatically when a card is mounted</strong></summary>
